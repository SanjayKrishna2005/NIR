...
################################################################
# This is a generated script based on design: nir_system
#
...
\
  ...
  # Create instance: zybo_top_0, and set properties
  set block_name zybo_top
  set block_cell_name zybo_top_0
  if { [catch {set zybo_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $zybo_top_0 eq "" } {
  ...
  # Create instance: bram_in, and set properties
  set bram_in [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 bram_in ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins bram_in/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins bram_out/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports btns_4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports btns_4bits_0] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb  [get_bd_pins bram_in/doutb] \
  [get_bd_pins zybo_top_0/bram_in_dout]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins zybo_top_0/ctrl_start]
  ...
  [get_bd_pins zybo_top_0/rst]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout  [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zybo_top_0_bram_in_addr  [get_bd_pins zybo_top_0/bram_in_addr] \
  [get_bd_pins bram_in/addrb]
  connect_bd_net -net zybo_top_0_bram_in_en  [get_bd_pins zybo_top_0/bram_in_en] \
  [get_bd_pins bram_in/enb]
  connect_bd_net -net zybo_top_0_bram_out_addr  [get_bd_pins zybo_top_0/bram_out_addr] \
  [get_bd_pins bram_out/addrb]
  connect_bd_net -net zybo_top_0_bram_out_din  [get_bd_pins zybo_top_0/bram_out_din] \
  [get_bd_pins bram_out/dinb]
  connect_bd_net -net zybo_top_0_bram_out_we  [get_bd_pins zybo_top_0/bram_out_we] \
  [get_bd_pins bram_out/web]
  connect_bd_net -net zybo_top_0_ctrl_done  [get_bd_pins zybo_top_0/ctrl_done] \
  [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net zybo_top_0_led  [get_bd_pins zybo_top_0/led] \
  [get_bd_ports led]
  ...
  assign_bd_address -offset 0x40002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
